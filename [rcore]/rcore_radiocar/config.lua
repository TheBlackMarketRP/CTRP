...
Config.StopUpdateAfterCertainSpeed = 35
...
-- how many music at once can be played in one position?
-- 6 = only 6 music in one radius can be heard, the rest music thats far away
...
if Config.MXSurround then
    ...
    Config.CustomHigherDistance = 75.0
end
