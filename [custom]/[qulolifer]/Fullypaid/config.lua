Config = {
    ...
    MenuImage = "https://media.discordapp.net/attachments/1170222644109512724/1447582036574601226/chitrenches_animated.gif?ex=69382554&is=6936d3d4&hm=91f88480e0baea7fdd6ff389139125cc5afadb98094e2b064b6efbbafc494776&=&width=808&height=463", ----REPLACE THIS LINK  ----[Custom banner imgur URLs go here ]---
...
Config.Languages = {
    ['en'] = { -- English 🇬🇧
        ['whitecustom'] = '~p~Animations~w~',
        ['whitecustom2do'] = '~p~OTHERS~w~',
        ['emotes'] = 'Emotes ',
        ['danceemotes'] = "🕺 Dances",
        ...
        ['cancelemoteinfo'] = "~p~X~w~ Cancels the currently playing emote",
        ...
        ['sentrequestto'] = "Sent request to ~r~",
        ['nobodyclose'] = "Nobody ~r~close~w~ enough.",
        ['doyouwanna'] = "~r~Y~w~ to accept, ~r~L~w~ to refuse (~g~",
        ['refuseemote'] = "Emote refused.",
        ['makenearby'] = "makes the nearby player play",
        ['useleafblower'] = "Press ~r~G~w~ to use the leaf blower.",
        ['camera'] = "Press ~r~G~w~ to use camera flash.",
        ['makeitrain'] = "Press ~r~G~w~ to make it rain.",
        ['pee'] = "Hold ~r~G~w~ to pee.",
        ['spraychamp'] = "Hold ~r~G~w~ to spray champagne",
    ...
    ['fr'] = { -- French 🇫🇷
        ['whitecustom'] = '~p~ANİMATİON~w~',
        ['whitecustom2do'] = '~p~Autres~w~',
        ['emotes'] = 'Emotes',
        ['danceemotes'] = "🕺 Danses",
