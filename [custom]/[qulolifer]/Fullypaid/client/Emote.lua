...
if Config.EnableXtoCancel then
    RegisterKeyMapping("emotecancel", "Annuler l'emote", "keyboard", "X")
end

if Config.MenuKeybindEnabled then
    RegisterKeyMapping("emotemenu", "Ouvrir le menu emote", "keyboard", Config.MenuKeybind)
end
...
function EmoteCommandStart(source, args, raw)
    if exports.ox_inventory:getCurrentWeapon() then exports['okokNotify']:Alert('Emote', 'Not Allowed While Gun in hand', 2000, 'error', false) return end
    if #args > 0 then
