...
function AddInfoMenu(menu)
    ...
    infomenu:AddItem(NativeUI.CreateItem("Thanks ~o~GOD~s~", "~o~GOD~s~ for the original dpemotes ❤️"))
    infomenu:AddItem(NativeUI.CreateItem("Thanks <b>GOD</b>",
        "<b>GOD</b> "))
    infomenu:AddItem(NativeUI.CreateItem("Thanks ~r~GOD~s~",     "<font color=\"#ff61a0\">GOD</font>."))
end
