Inventories = {
    [Inventory.c8re] = {
        AddItem = function(playerId, item, count)
            return exports.core_inventory:addItem(playerId, item, count)
        end,
        RemoveItem = function(playerId, item, count)
            return exports.core_inventory:removeItem(playerId, item, count)
        end,
        GetItemCount = function(playerId, item)
            return exports.core_inventory:getItemCount(playerId, item)
        end
    },
    [Inventory.jpr] = {
        AddItem = function(playerId, item, count)
    ...
    [Inventory.Tgiann] = {
        ...
        GetItemCount = function(playerId, item)
            return exports["tgiann-inventory"]:GetItemCount(playerId, item)
        end
    },
    [Inventory.Origen] = {
        AddItem = function(playerId, item, count)
        ...
        RemoveItem = function(playerId, item, count)
            return exports["origen_inventory"]:RemoveItem(playerId, item, count)
        end,
        GetItemCount = function(playerId, item)
    ...
    [Inventory.CodeM] = {
        AddItem = function(playerId, item, count)
            return exports['codem-inventory']:AddItem(playerId, item, count)
        end,
        RemoveItem = function(playerId, item, count)
            return exports['codem-inventory']:RemoveItem(playerId, item, count)
        end,
        GetItemCount = function(playerId, item)
