SocietyBanking = {
    ...
    [Society.kartikBanking] = {
        AddMoney = function(money)
            exports['kartik-banking']:AddAccountMoney(Config.SocietyName, money, "casino")
        end,
        RemoveMoney = function(money)
            exports['kartik-banking']:RemoveAccountMoney(Config.SocietyName, money, "casino")
        end,
        GetBalance = function()
            return exports['kartik-banking']:GetAccountMoney(Config.SocietyName) or 0
        end
    },
    [Society.Tgiann] = {
        AddMoney = function(money)
    ...
    [Society.SnipeBanking] = {
        ...
        RemoveMoney = function(money)
            exports["snipe-banking"]:RemoveMoneyFromAccount(Config.SocietyName, money)
        end,
        GetBalance = function()
            return exports['snipe-banking']:GetAccountBalance(Config.SocietyName)
        end
    },
    [Society.Tgg] = {
        AddMoney = function(money)
