Config = {
    ...
    -- Map
    ActiveMaps = {1}, -- list of enabled map types (see below for types)
    ...
    InventoryResource = Inventory.OX, -- name of the inventory resource, set to Inventory.Framework if you want to use frameworks' inventory functions
    --[[
    ...
    MoneyInventoryItemName = casino_chips, -- name of the money inventory item, set to nil, if you don't want to use inventory item as the money
    ...
    ForceNormalKeyLabels = false, -- whether to replace blip icon codes (~INPUT_TALK~) with text ([E], [F], [G], etc.)
