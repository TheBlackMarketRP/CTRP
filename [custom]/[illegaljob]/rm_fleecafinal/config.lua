...
Config['FleecaHeist'] = {
    ['framework'] = {
        ...
        eventName = '', -- If your framework using trigger event for shared object, you can set in here.
    },
    ['bagClothesID'] = 45,
    ...
    ['rewardItems'] = { -- Add this items to database or shared. Don't change the order, you can change the item names. You can add more items for lockboxes.
        {itemName = 'goldingot', count = 1, sellPrice = 50}, -- For trolly/lockboxes.
        {itemName = 'diamond', count = 1, sellPrice = 50}, -- For lockboxes.
    },
    ['rewardMoneys'] = {
        ['stacks'] = function()
...
policeAlert = function(coords)
    ...
    elseif Config['FleecaHeist']["dispatch"] == "sonoran_cad" then
...
Strings = {
    ...
    ['drill_bar'] = 'DRILLING',
    ['wait_nextrob'] = 'You have to wait this long to rob this bank again',
    ['minute'] = 'minute.',
