Locations = {
    ...
    ["Panning"] = {
        ...
        positions = {
            ["Vineyard"] = {
                ...
                Positions = {
                    { coords = vec4(-1396.3, 2004.59, 58.59, 82.0), w = 22.1, d = 4.0 },
                    { coords = vec4(-1410.08, 2006.08, 55.8, 89.0), w = 6.3, d = 4.2 },
                    { coords = vec4(-1418.62, 2006.05, 55.41, 89.0), w = 10.9, d = 6.0 },
                }
            },
            ["Tongva"] = {
                Enable = true,
                ...
                Positions = {
                    { coords = vec4(-1550.06, 1445.13, 114.37, 139.0), w = 10.9, d = 6.0 },
                    { coords = vec4(-1562.88, 1434.03, 114.19, 129.0), w = 24.3, d = 6.0 },
                }
            },
            ["Wilderness"] = {
                Enable = true,
	...
	['JewelBuyer'] = { -- The Location of the jewel buyer, I left this as Vangelico, others will proabably change to pawn shops
        Enable = true,
        positions = {
            { name = "Jewel Buyer", coords = vector4(1699.66, 3786.49, 34.79, 215.73), sprite = 527, col = 13, blipTrue = true, model = `S_M_M_HighSec_03`, scenario = "WORLD_HUMAN_CLIPBOARD", },
        },
    },
    ["Smelting"] = {
