...
Config.reward = 10000                    -- Reward for one treasure. If you want to use a item reward then modify Pay() function under /server/functions.lua
...
Config.Clothes = {
    male = {
        ...
        ["pants"] = {clotheId = 183, variation = 3},
        ["bag"] = {clotheId = 0, variation = 0},
        ["shoes"] = {clotheId = 114, variation = 0},
        ["t-shirt"] = {clotheId = 16, variation = 0},
        ["torso"] = {clotheId = 339, variation = 3},
...
Config.Lang = {
    ...
    ["exploit"] = "You can't grab treasure while somebody is nearby", 
