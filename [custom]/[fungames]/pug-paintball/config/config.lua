...
Config.ArmorAmountGivenToPlayer = 100 -- Armor value (0–100) given to players each time they spawn
...
Config.EnableWager = false -- Enables the wager menu option and ability for people to bet games against one another
