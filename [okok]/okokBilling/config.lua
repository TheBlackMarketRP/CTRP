...
Config.AuthorPercentage = 25 -- Percentage that the invoice author receives

Config.VATPercentage = 0

Config.SocietyReceivesLessWithVAT = false

Config.QBManagement = false -- If set to true it will use the qb-management resource, if set to false it will use the okokBanking database tables

Config.UseQBBanking = true -- Useful for latest QBCore versions

Config.RenewedBanking = false -- If you use Renewed-Banking set this to true
