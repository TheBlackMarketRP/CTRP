...
Config.GarageLocations = { -- IMPORTANT - Every garage name must be unique
  ...
  ["ospillbox"] = { -- If you change the name of this garage from Legion Square, you must change the default value of `garage_id` to the same name in the SQL table `players_vehicles`
    coords = vector3(264.49, -617.85, 42.29),
    spawn = {vector4(260.36, -620.05, 41.28, 154.99)}, --  you can add multiple spawn locations into a table
    distance = 15,
    type = "car",
    hideBlip = false,
    blip = {
  ...
  ["Puff Puff Pass"] = {
    coords = vector3(-1536.5, -428.87, 35.59),
    spawn = vector4(-1533.19, -432.23, 34.81, 228.46),
    distance = 15,
    type = "car",
    hideBlip = false,
    blip = {
  ...
  ["Sandyhospital"] = {
    coords = vector3(1766.41, 3633.22, 34.82),
    spawn = vector4(1768.14, 3628.95, 34.04, 124.03),
    distance = 15,
    type = "car",
    hideBlip = false,
    blip = {
  ...
  ["Zonahhospital"] = {
    coords = vector3(-463.12, -338.13, 34.5),
    spawn = vector4(-467.84, -338.18, 34.37, 165.84),
    distance = 15,
    type = "car",
    hideBlip = false,
    blip = {
  ...
  ["Paleto Hospital"] = {
    coords = vector3(-231.3, 6314.96, 31.46),
    spawn = vector4(-228.12, 6311.14, 31.42, 311.12),
    distance = 15,
    type = "car",
    hideBlip = false,
    blip = {
  ...
  ["lakeBoats"] = {
    coords = vector3(1446.4, 3805.31, 31.81),
    spawn = vector4(1461.32, 3819.31, 29.09, 20.31),
    distance = 20,
    type = "sea",
    hideBlip = false,
    blip = {
  ...
  ["deepseaBoats"] = {
    coords = vector3(3372.37, 5183.93, 1.46),
    spawn = vector4(3392.07, 5194.39, -0.88, 308.09),
    distance = 20,
    type = "sea",
    hideBlip = false,
    blip = {
...
Config.JobGarageLocations = { -- IMPORTANT - Every garage name must be unique
  ...
  ["Kush"] = {
    coords = vector3(1659.84, 3805.43, 35.11),
    spawn = vector4(1666.5, 3812.86, 34.92, 340.82),
    distance = 15,
    job = {"kush"},
    type = "car",
    hideBlip = false,
...
Config.ImpoundLocations = { -- IMPORTANT - Every impound name must be unique
  ...
  -- },
  ["Impound B"] = {
    coords = vector3(1866.72, 3679.19, 33.69),
    spawn = vector4(1869.18, 3674.53, 33.12, 121.97),
    distance = 15,
    type = "car",
    job = {"police"},
    hideBlip = false,
