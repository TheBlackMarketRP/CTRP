...
Config.CallMedicCommand = 'medic' -- Command to call the ambulance
...
Config.FailSafeArriveTimeout = false -- Time in MINS before the ambulance will skip to the next stage if it is stuck on the way to the player  -- Set To false To Disable
...
Config.FailSafeGetInAmbulanceTimeout = false -- Time in SECONDS before the player will be teleported into the ambulance if they are stuck on the way to the ambulance -- Set To false To Disable
Config.FailSafeDriveToHospitalTimeout = 1 -- Time in MINS before the ambulance will skip to the the final revive stage if it is stuck on the way to the hospital -- Set To false To Disable
...
Config.AutoMedicCleanUpTime = 5 -- Time in MINS after the ambulance for the ambulance to force despawn
...
Config.UltimateTimeOutTime = 5 -- Time in MINS before the ambulance will force despawn and a MAGIC PED will revive the player
...
Config.ReviveCostSuccessfulSkillCheck  = 15000      -- How much it costs to be revived if you spawn back in the hospital (if AlwaysTakeToHosptial is set to true and you pass the minigame)
Config.ReviveCostFailedSkillCheck  = 15000      -- How much it costs to be revived if you spawn back in the hospital (if you fail the minigame)  -- will default to this if you do not use skillcheck or if AlwaysTakeToHosptial is set to false
...
Config.FreezeOnRevive = false -- Set to true if you want to freeze the player when they are being revived
                             -- Set to false if you want the player to be able to move around when they are being revived
-- NEW IN 1.7.0 -- 
Config.CallAnimDisabled = false -- Set to true if you want to disable the call animation
...
local reviveEvent = 'wasabi_ambulance:revive'
local fuelEvent = nil
