...
Config.GPSBlips = { -- Requires wasabi_gps, get it free here: https://wasabiscripts.com/product/7093977
    ...
    jobs = {        --- wasabi_gps job registration
        ...
        -- ['fire'] = {
        --     subscribers = { 'fire', 'ambulance' }, --- who can see these blips?
        --     blipSettings = {
        --         color = 17,                        -- Orange
        --         scale = 1.0,
        --         short = false,
...
Config.KnockoutFeature = {
    ...
    healthForKnockout = 1,   -- At what HP will player knockout from fist fighting
    fistDamageModifier = 0.02, -- How much damage will fist cause? (1.0 is default, 0.5 is half as strong, etc) Set to false to disable
    duration = 5 * seconds     -- Time to be knocked out when occurs?
}
...
Config.BleedMultiplier = {
    shot = 0,    -- How much blood rate to loose when shot
    stabbed = 0, -- How much blood rate to loose when stabbed
...
Config.BleedoutTimer = 6 * minutes -- Time before it forces respawn
...
Config.ReviveRewards = {
    ...
    burned = 15000,            -- How much if player is burned and revived without being treated
    beat = 15000,              -- So on, so forth
    stabbed = 15000,
    bleedout = 15000,          -- NEW
    shot = 15000,
}
...
Config.ReviveTime = 9 * seconds   -- Time to revive player
...
Config.CheckIfJailed = {
    ...
    resource = 'tk_jail'                       -- Options: 'wasabi_police' (if you are using our police job's built-in jail system) / 'qb-prison' / 'rcore_prison' / 'tk_jail' / 'r_prison' / You can add your own in client/cl_customize.lua
}
...
Config.Locations = {
    Pillbox = {
        ...
        clockInAndOut = {
            ...
            locations = {                          -- Location of where to go on and off duty(If not using target)
                {
                    coords = vec3(334.75, -580.24, 43.28),
                    jobLock = false                 -- Set to false to allow all jobs to access, or set to job name to restrict access
                },
                -- Add more non-target locations here if needed (if target is not enabled)
            },
        ...
        PersonalLocker = {
            ...
            locations = {                           -- Location of where to access personal locker (If target is disabled)
                {
                    coords = vec3(298.61, -598.28, 43.28),
                    jobLock = false                 -- Set to false to allow all jobs to access, or set to job name to restrict access
                },
            ...
            target = {
                ...
                locationsArray = {
                    {
                        coords = vec3(283.27, -615.33, 43.38),
                        heading = 70.18,
                        width = 2.0,
                        length = 1.0,
                        minZ = 43.38 - 0.9,
        ...
        BossMenu = {
            ...
            locations = {                          -- Location of boss menu (If not using target)
                {
        ...
        CheckIn = {                                      -- Hospital check-in
            ...
            locations = {
                {
                    ped = 's_m_m_scientist_01',                     -- Check in ped (false for no ped)
                    coords = vec3(308.58, -595.31, 43.28-0.9),
                    heading = 63.26,
                    jobLock = false                      -- Set to false to allow all jobs to access, or set to job name to restrict access
                },
                ...
                --     coords = vec3(311.45, -594.2, 43.28-0.9),
                --     heading = 335.87,
                --     jobLock = false
                -- },
            ...
            Duration = 1 * seconds,                     -- Time it takes to spend in hospital bed
            ...
            RespawnNoBedLocation = { coords = vector3(317.02, -593.77, 43.29), heading = 73.37 }, -- Coords and heading of where to spawn player if DisableHospitalBeds is set to true or beds are full
            HospitalBeds = {
                --              { coords = vec3(332.62, -587.17, 42.84+0.3), heading = 160.0 },
                { coords = vec3(317.67, -585.37, 42.84 + 0.3), heading = 160.0 },
        ...
        MedicalSupplies = {                                                     -- EMS Shop for supplies
            ...
            locations = {                                                      -- Coords of ped/target
                {
                    ped = 's_m_m_doctor_01',                                    -- Ped to target (false for no ped)
                    coords = vec3(306.63, -601.44, 43.28 - 0.95),
                    heading = 337.64,
                    jobLock = false                                             -- Set to false to allow all jobs to access, or set to job name to restrict access
                },
                -- Add more non-target locations here if needed (if target is not enabled)
            },
            Distance = 2.5,                                                    -- Distance to show textUI (If target is not enabled below)
            Target = {
                enabled = true,                          -- Enable Target? (Can be customized in wasabi_bridge/customize/cl_customize.lua the target system)
        ...
        Vehicles = {                                   -- Vehicle Garage
            ...
            locations = {

                {
                    ...
                    jobLock = false,  -- Set to 'ambulance' or a table of jobs to restrict access to specific jobs
                    Options = {
                ...
                -- Add garages to this hospital here (example below)

                -- EXAMPLE: Add more garage locations here if needed
                -- {
                --     Zone = {
                --         coords = vec3(0.0, 0.0, 0.0),  -- Different garage location
                --         range = 5.5,
                --         label = '[E] - Access Garage',
                --         return_label = '[E] - Return Vehicle'
                --     },
                ...
                --         }
                --     },
                --     jobLock = false,  -- Set to 'ambulance' or table of jobs to restrict
                --     Options = {
                --         [0] = {
                --             ['ambulance'] = {
                --                 label = 'Ambulance',
    ...
    Palleto = {
        RespawnPoint = { -- When player dies and bleeds out; they will revive at nearest hospital; Define the coords of this hospital here.
            coords = vector3(-254.71, 6328.36, 32.43),
            heading = 332.22,
            -- Even if you have useCheckInInstead to true, you must still define these coords for finding closest hospital
            -- If you want to use check-in instead of respawning at this location(Otherwise will just spawn at the coords above)
            useCheckInInstead = true
        ...
        clockInAndOut = {
            ...
            locations = {                          -- Location of where to go on and off duty(If not using target)
                {
                    coords = vector3(-258.06, 6332.22, 32.43),
                    jobLock = false                 -- Set to false to allow all jobs to access, or set to job name to restrict access
                },
                -- Add more non-target locations here if needed (if target is not enabled)
            },
        ...
        PersonalLocker = {
            ...
            locations = {                           -- Location of where to access personal locker (If target is disabled)
                {
                    coords = vector3(-256.18, 6327.63, 32.43),
                    jobLock = false                 -- Set to false to allow all jobs to access, or set to job name to restrict access
                },
        ...
        CheckIn = {                                      -- Hospital check-in
            ...
            locations = {
                {
                    ped = 's_m_m_scientist_01',                     -- Check in ped (false for no ped)
                    coords = vector3(-254.71, 6328.39, 32.43-1),
                    heading = 272.78,
                    jobLock = false                      -- Set to false to allow all jobs to access, or set to job name to restrict access
                },
            ...
            DisableHospitalBeds = true,                                                       -- Disable hospital beds for check-in at this location?(Player will spend Duration checking in before respawning in RespawnNoBedLocation when set to true)
            RespawnNoBedLocation = { coords = vector3(-246.79, 6322.61, 32.43), heading = 312.07 }, -- Coords and heading of where to spawn player if DisableHospitalBeds is set to true or beds are full
            HospitalBeds = {
                --              { coords = vec3(332.62, -587.17, 42.84+0.3), heading = 160.0 },
                { coords = vec3(317.67, -585.37, 42.84 + 0.3), heading = 160.0 },
                { coords = vec3(319.41, -581.04, 42.84 + 0.3), heading = 340.0 },
        ...
        MedicalSupplies = {                                                     -- EMS Shop for supplies
            ...
            locations = {                                                      -- Coords of ped/target
                {
                    ped = 's_m_m_doctor_01',                                    -- Ped to target (false for no ped)
                    coords = vector3(-259.99, 6330.71, 32.43-1),
                    heading = 253.51,
                    jobLock = false                                             -- Set to false to allow all jobs to access, or set to job name to restrict access
                },
                -- Add more non-target locations here if needed (if target is not enabled)
    ...
    Zonah = {
        RespawnPoint = { -- When player dies and bleeds out; they will revive at nearest hospital; Define the coords of this hospital here.
            coords = vector3(-454.58, -341.4, 34.36),
            heading = 165.64,
            -- Even if you have useCheckInInstead to true, you must still define these coords for finding closest hospital
            -- If you want to use check-in instead of respawning at this location(Otherwise will just spawn at the coords above)
            useCheckInInstead = true
        ...
        Blip = {
            ...
            Color = 2,
            Scale = 1.0,
            String = 'Mount Zonah Medical Center'
        },
        ...
        CheckIn = {                                      -- Hospital check-in
            ...
            locations = {
                {
                    ped = 's_m_m_scientist_01',                     -- Check in ped (false for no ped)
                    coords = vector3(-447.49, -340.81, 34.5-1),
                    heading = 77.68,
                    jobLock = false                      -- Set to false to allow all jobs to access, or set to job name to restrict access
                },
            ...
            DisableHospitalBeds = true,                                                       -- Disable hospital beds for check-in at this location?(Player will spend Duration checking in before respawning in RespawnNoBedLocation when set to true)
            RespawnNoBedLocation = { coords = vector3(-454.65, -339.98, 34.36), heading = 157.98 }, -- Coords and heading of where to spawn player if DisableHospitalBeds is set to true or beds are full
            HospitalBeds = {
                --              { coords = vec3(332.62, -587.17, 42.84+0.3), heading = 160.0 },
                { coords = vec3(317.67, -585.37, 42.84 + 0.3), heading = 160.0 },
                { coords = vec3(319.41, -581.04, 42.84 + 0.3), heading = 340.0 },
    ...
    Sandy = {
        RespawnPoint = { -- When player dies and bleeds out; they will revive at nearest hospital; Define the coords of this hospital here.
            coords = vector3(1739.57, 3632.13, 34.85),
            heading = 211.22,
            -- Even if you have useCheckInInstead to true, you must still define these coords for finding closest hospital
            -- If you want to use check-in instead of respawning at this location(Otherwise will just spawn at the coords above)
            useCheckInInstead = true
        ...
        Blip = {
            Enabled = true,
            Coords = vector3(1768.16, 3641.54, 34.85),
            Sprite = 61,
            Color = 2,
            Scale = 1.0,
            String = 'Sandy Shores Medical Center'
        },
        ...
        clockInAndOut = {
            ...
            locations = {                          -- Location of where to go on and off duty(If not using target)
                {
                    coords = vector3(1809.71, 3677.87, 34.28),
                    jobLock = false                 -- Set to false to allow all jobs to access, or set to job name to restrict access
                },
                -- Add more non-target locations here if needed (if target is not enabled)
            },
        ...
        CheckIn = {                                      -- Hospital check-in
            ...
            locations = {
                {
                    ped = 's_m_m_scientist_01',                     -- Check in ped (false for no ped)
                    coords = vector3(1768.16, 3641.54, 34.85-1),
                    heading = 154.44,
                    jobLock = false                      -- Set to false to allow all jobs to access, or set to job name to restrict access
                },
            ...
            Target = {
                ...
                locationsArray = {
                    ...
                    {
                        ped = 's_m_m_scientist_01',                     -- Check in ped (false for no ped)
                        coords = vector3(1816.37, 3678.7, 34.28-1),
                        heading = 25.52,
                        distance = 5.0,
                        width = 2.0,
                        length = 1.0,
            ...
            DisableHospitalBeds = true,                                                       -- Disable hospital beds for check-in at this location?(Player will spend Duration checking in before respawning in RespawnNoBedLocation when set to true)
            RespawnNoBedLocation = { coords = vector3(1739.16, 3632.33, 34.85), heading = 24.33 }, -- Coords and heading of where to spawn player if DisableHospitalBeds is set to true or beds are full
            HospitalBeds = {
                --              { coords = vec3(332.62, -587.17, 42.84+0.3), heading = 160.0 },
                { coords = vec3(317.67, -585.37, 42.84 + 0.3), heading = 160.0 },
                { coords = vec3(319.41, -581.04, 42.84 + 0.3), heading = 340.0 },
...
Config.DutyCarModel = "ghispo3"
Config.PullBodiesRadus = 55.0