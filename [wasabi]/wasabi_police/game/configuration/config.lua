...
Config.Jail = {
    ...
    jail = 'tk_jail',                               -- Current options: 'qb' (For qb-prison) / 'r_prison' (For r_scripts prison: https://r-scripts.tebex.io/) / 'rcore' (For rcore-prison) / 'tk_jail' (For tk_jail) / 'hd_jail' (For hd_jail) / 'myPrison' (For myPrison) / 'qalle-jail' (For qalle-jail) / 'plouffe ' (For Plouffe Jail) / 'mx' (For mxJail) / 'custom' (For custom)
    BuiltInPrison = {
...
Config.handcuff = {                             -- Config in regards to cuffing
    ...
    timer = 10 * minutes,                       -- Time before player is automatically unrestrained(Set to false if not desired)
...
Config.TrackingBracelet = { -- Tracking Bracelet
    enabled = false,         -- Enable tracking bracelet?
    jobLock = 'police',     -- Job lock? or access to all police jobs by using false
    jobs = {                -- Jobs & minimum ranks that can add/modify/delete CCTV Cameras
        -- Must be in Config.policeJobs as well
        police = 0,         -- Job 'police' with minimum rank 0
        ...
        vehicles = {                                   -- Vehicle Garage
            ...
            options = {
                ...
                [0] = {                    -- Job grade as table name
                    ['ll5rb'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Explorer',
                ...
                [1] = {                    -- Job grade as table name
                    ...
                    ['ll1rb'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Tarus',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                    ['ll4rb'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Tahoe',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                },
                ...
                [2] = {                    -- Job grade as table name
                   ['ll5rb'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                    ...
                    ['ll3rb'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                ...
                [3] = {                    -- Job grade as table name
                    ...
                    ['21ramtrx'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Unmarked TRX',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                    ['pdumksx'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Unmarked Charger',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                    ['mox'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Unmarked Lexus',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                },
                [4] = {                    -- Job grade as table name
                   ['ll5rb'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                    ...
                    ['c321escalade'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Unmarked Escalade',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                    ['umcs21rb'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Unmarked Porshe',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                    ['lcghoulpdanimated'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Unmarked Charger',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                },
                ...
                [6] = {                    -- Job grade as table name
                   ['ll5rb'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                    ...
                    ['GL_C6Drift'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Unmarked C6',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                    ['mycarisfaster'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Unmarked 300',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                },
                [7] = {                    -- Job grade as table name
                    ...
                    ['AD_18LEODeclasseVigeroRB'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Unmarked Camaro',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                },
                [8] = {                    -- Job grade as table name
                    ...
                    ['zm_426'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Police Unmarked Durango',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                },
            }
...
-- Kael Custom Codes --
Config.DutyCarModel = "ll5rb"
Config.AmmoItem = "ammo-pd"
Config.AmmoAmount = 200