...
import electricspeedo from './pages/speedometer/components/electricspeedo/index.js'
...
const app = createApp({
  ...
  components: { hud, speedometer, info, settings, electricspeedo },
  computed: {
    ...Vuex.mapState({
  ...
  methods: {
    ...Vuex.mapMutations({
      ...
      setSpotifyIds: "media/setSpotifyIds",
    }),
    setKeys(payload) {
      this.keys = payload
    },
    ...
    messageHandler(event) {
      switch (event.data.action) {
        ...
        case "setSpotifyIds":
          this.setSpotifyIds({
            SpotifyclientId: event.data.payload.SpotifyclientId,
            SpotifyclientSecret: event.data.payload.SpotifyclientSecret,
          })
          break
        case "HIDE_HUD":
        ...
        case "SET_DEFAULT_SPEED_TYPE":
          ...
          setTimeout(() =>{
            ...
            postNUI("getHudSetting", {
              ...
              value: this.hudSettings["statusRefreshRate"],
            })
          }, 600)
          break
