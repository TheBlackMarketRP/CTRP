...
Config.FuelSystem = 'LegacyFuel' -- LegacyFuel / ox-fuel / nd-fuel / frfuel / cdn-fuel / x-fuel
...
Config.newManagementSystem = false -- true : use new management system || false : use old management system
...
Config.SeatbeltEjectSpeed = 1000 -- adjust this value in kmh 
...
Config.WaterMarkInformations = { -- informations displayed in the upper right watermark
    logo = "https://media.discordapp.net/attachments/812271161596837918/1447557321180975176/myLogo.png?ex=69380e4f&is=6936bccf&hm=62315393d417a822ce0e02179e9850b93ce6857c1f5b7190604c1cd79db6957b&=&format=webp&quality=lossless",
    servername = "ChiTrenches RP",
    discordlink = "discord.gg/chitrenches"
}
                ...
                if Config.Framework == 'esx' or Config.Framework == 'oldesx' then
                    ...
                    for _,v in pairs(PlayerData.items) do
                        if v and v.name == 'markedbills' then
                            LoadPlayerMoney("black_money", v.count)                                
                        end
                    end
    ...
    vip_money = {
        ...
        getMoney = function(this)
            ...
            -- end)
                ...
                local myVipMoney = TriggerCallback("kael-vcoin:server:getcoin")
                LoadPlayerMoney("vip_money", myVipMoney)                       
                
                RegisterNetEvent("kael-vcoin:client:vcoinchanges", function()
                    local myVipMoney = TriggerCallback("kael-vcoin:server:getcoin")
                    LoadPlayerMoney("vip_money", myVipMoney)  
                end)
...
Config.Gift = {
    ...
    time = 60, -- x mn play time to give gift
    rewards = {
        {
            type = "item",
            name = "cash",
...
Config.CoinFunction = function(src, amount)
    ...
    exports['ak47_qb_vipshop']:addPlayerCoin(src, amount)
end
