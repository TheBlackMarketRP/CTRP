...
Config.MaxHouseLimit = 3        --How many house a player can own
...
Config.Blip = {
    interior = {
        ...
        familyhouse     = {enable = false, id = 40,  color = 3,  size = 0.6, displaytype = 6},
        neighbourhouse  = {enable = false, id = 40,  color = 2,  size = 0.6, displaytype = 6},
        empty           = {enable = true, id = 350, color = 18, size = 0.4, displaytype = 6},
    },
    mlo = {
        myhouse         = {enable = true, id = 176, color = 3,  size = 0.8, displaytype = 6},
        familyhouse     = {enable = false, id = 176, color = 3,  size = 0.6, displaytype = 6},
        neighbourhouse  = {enable = false, id = 176, color = 2,  size = 0.6, displaytype = 6},
