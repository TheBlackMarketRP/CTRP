...
Notify = function(source, msg, type)
	TriggerClientEvent('ak47_qb_fishing:notify', source, msg, type)
end

GetPlayerMetaValue = function(source, type)
	local xPlayer = GetPlayer(source)
	return xPlayer.Functions.GetMetaData(type)
end

SetPlayerMetaValue = function(source, type, val)
	local xPlayer = GetPlayer(source)
	return xPlayer.Functions.SetMetaData(type, val)
end

QBCore.Functions.CreateUseableItem('fishingrod', function(source, item)
    TriggerClientEvent('ak47_qb_fishing:client:startFishing', source, 'fishingrod')
end)

QBCore.Functions.CreateUseableItem('reinforcedrod', function(source, item)
    TriggerClientEvent('ak47_qb_fishing:client:startFishing', source, 'reinforcedrod')
end)