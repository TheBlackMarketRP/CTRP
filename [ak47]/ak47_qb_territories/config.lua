...
Config.Commands = {
    ...
    startsell   = '',   -- event name ("ak47_qb_territories:startsell")
    stopsell    = '',    -- event name ("ak47_qb_territories:stopsell")
...
Config.ShowZoneBlip = 'gangonly'     -- 'all', 'gangonly', 'admin', 'hide'
Config.AreaInfo = 'gangonly'    -- 'all', 'gangonly', 'admin', 'hide'
Config.FlashAreaInfo = true     -- if enabled then info will be visible for a moment when player enter the zone or changes the influence
...
Config.Garage = {
    script = 'jg-advancedgarages' -- ak47_qb_garage, cd_garage, okokGarage, qb-garages, jg-advancedgarages, loaf_garage
}
...
Config.Currency = {
    cash = "Cash",
    bank = "Bank",
    markedbills = "Marked Money", -- keep the name coin if you want to use special coin system
